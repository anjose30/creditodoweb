        ...
        >
          ...
          >
            ...
            <div className="grid gap-6">
              ...
              <motion.button
                type="submit"
                className="bg-gradient-to-r from-yellow-300   to-credi-orange text-white py-4 px-8 rounded-xl hover:from-credi-blue/90 hover:to-credi-orange/90 transition-all duration-200 hover:shadow-xl transform hover:scale-[1.02] font-semibold"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
